...
class Config:
    ...
    def __init__(self, config_file: str = None):
        self.config_file = config_file or "kg_core/config/default_config.json"
        ...
        # 其他配置
        self.output_dir = "kg_core/output"
        self.data_dir = "kg_core/data"
        self.log_level = "INFO"
        self.enable_caching = True
        self.cache_dir = "kg_core/cache"
